...
class BaseTrainer:
    ...
    def _calc_metrics(self):
        ...
        # --- Tambahkan Kode di Sini untuk Menghitung dan Menampilkan Metrik ---
        classification_report_result = classification_report(all_trgs, all_outs)
        accuracy = accuracy_score(all_trgs, all_outs)
        kappa = cohen_kappa_score(all_trgs, all_outs)
        conf_matrix = confusion_matrix(all_trgs, all_outs)
        ...
        # Simpan hasilnya ke dalam file seperti yang sudah ada
