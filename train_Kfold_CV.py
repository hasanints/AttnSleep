...
def main(config, fold_id, folds_data, data_count):
    ...
    for epoch in range(1, config['trainer']['epochs'] + 1):
        trainer._train_epoch(epoch, config['trainer']['epochs'])
...
if __name__ == '__main__':
    ...
    # Determine the class weights or any other preprocessing
    data_count = None  # Placeholder; calculate or load as needed.

    # Call main function to start training
    main(config, fold_id, folds_data, data_count)
